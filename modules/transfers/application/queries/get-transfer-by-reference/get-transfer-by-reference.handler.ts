...
export class GetTransferByReferenceHandler
  implements IQueryHandler<GetTransferByReferenceQuery, TransferResponseDto>
{
  constructor(@Inject(TRANSFER_REPOSITORY) private readonly transferRepository: ITransferRepository) {}
